...
public class RaycastUtil {
    ...
    static {
        try { // TODO do the same thing as on forge
            _traverseBlocks = BlockGetter.class.getDeclaredMethod("method_17744", Vec3.class, Vec3.class, Object.class, BiFunction.class, Function.class);
