...
public class NewAgeEmiPlugin implements EmiPlugin {
    ...
    public static final EmiStack ENERGISING_WORKSTATION = EmiStack.of(NewAgeBlocks.ENERGISER_T1.asStack().getItem().getDefaultInstance());
    public static final EmiStack ENERGISING_WORKSTATION_2 = EmiStack.of(NewAgeBlocks.ENERGISER_T2.asStack().getItem().getDefaultInstance());

    public static final EmiStack ENERGISING_WORKSTATION_3 = EmiStack.of(NewAgeBlocks.ENERGISER_T3.asStack().getItem().getDefaultInstance());
